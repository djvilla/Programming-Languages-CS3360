  ...
  <tr>
    ...
    <th>
        <?php
            ...
            if(in_array("My Code", $_SESSION['songsAdded'])) {
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            //If song is already in the library, hide button. Else, show the button.
            if(in_array("Five Dolla Ft Long", $_SESSION['songsAdded'])) {
                echo "<form action=\"Zmazon.php\" method=get>
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            //If song is already in the library, hide button. Else, show the button.
            if(in_array("Lice Breakers", $_SESSION['songsAdded'])) {
                echo "<form action=\"Zmazon.php\" method=get>
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            //If song is already in the library, hide button. Else, show the button.
            if(in_array("Soothing Sounds of Dolphin Screams", $_SESSION['songsAdded'])) {
                echo "<form action=\"Zmazon.php\" method=get>
