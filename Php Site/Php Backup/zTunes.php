...
<?php
    session_start();
    //Check to see who to sign in so we can store their songs
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            if(in_array("Ben Franklin's Song", $_SESSION["user$q"]['songsAdded'])) {
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            //If song is already in the library, hide button. Else, show the button.
            if(in_array("Ow! My Face", $_SESSION["user$q"]['songsAdded'])) {
                echo "<form action=\"zTunes.php\" method=get>
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            //If song is already in the library, hide button. Else, show the button.
            if(in_array("We Got the Meat", $_SESSION["user$q"]['songsAdded'])) {
                echo "<form action=\"zTunes.php\" method=get>
  ...
  <tr>
    ...
    <th>
        <?php
            ...
            //If song is already in the library, hide button. Else, show the button.
            if(in_array("Neon Cat", $_SESSION["user$q"]['songsAdded'])) {
                echo "<form action=\"zTunes.php\" method=get>
